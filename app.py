...
st.markdown(
    ...
    /* Hide Streamlit's auto-discovered pages nav (app/breadth analysis/page spread etc.) */
...
with st.sidebar:
    ...
    PAGE_OPTIONS = {
        "  Yield":            "yield_gap",
        "  Nifty vs Gold":   "spread",
        " NIfty 500 outperformance":  "breadth",
    }
    page_label = st.radio(
        "page",
    ...
    if active_page == "yield_gap":
        ...
        st.caption("Nifty 50 − Gold BeES  ·  rolling return difference with Avg / ±1σ / ±2σ bands.")
        pe_ratio = 21.27
