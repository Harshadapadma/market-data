...
def _header() -> None:
    st.markdown(
        f"<div style='font-size:12px;color:{_GREY};font-family:{_FONT};"
        f"margin-bottom:14px'>What % of stocks outperform the benchmark's rolling return?</div>"
        f"<hr style='border-color:{_BORDER};margin:0 0 16px 0'>",
